...
<div id="breadcrumbs-nav">
  	...
  	<div id="secondary-cat">
        ...
        <li><a href="/products/below-the-hook/magnets-overview/">Magnets</a></li>
		 	<li><?php the_title(); ?></li>
  		</ul>
	</div>
  	</div>
   ...
   <div id="content-outerWrap" class="clearfix">
  	...
  	<?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('Magnets Submenu Sidebar')) : else : ?><?php endif; ?>
  	</aside>
