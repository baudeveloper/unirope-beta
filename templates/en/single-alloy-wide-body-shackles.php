...
<div id="breadcrumbs-nav">
  	...
  	<div id="secondary-cat">
  		<ul>
  			<li><a href="/products/rigging-hardware/">Rigging Hardware</a></li>
				<li><a href="/products/rigging-hardware/shackles-hooks/">Shackles & Hooks</a></li>
  			<li><a href="/rigging-hardware/alloy-wide-body-shackles/">Alloy Wide Body Shackles</a></li>
  		  	<li><?php the_title(); ?></li>
  		</ul>
	</div>
  	</div>
   ...
   <div id="content-outerWrap" class="clearfix">
  	...
  	<?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('Alloy Wide Body Shackles Submenu Sidebar')) : else : ?><?php endif; ?>
  	</aside>
