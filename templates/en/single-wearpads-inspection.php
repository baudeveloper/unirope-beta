...
<div id="breadcrumbs-nav">
  	...
  	<div id="secondary-cat">
  		...
  		<li><a href="/products/slings/">Slings</a></li>
  			<li><a href="/products/slings/twin-path-and-synthetic-lifting-slings/">Twin-Path® Slings</a></li>
  			<li><a href="/sling/wear-pads-sling-protection//">Wear Pads – Sling Protection</a></li>
  		  	<li><?php the_title(); ?></li>
  		</ul>
	</div>
  	</div>
   ...
   <div id="content-outerWrap" class="clearfix">
  	...
  	<?php get_sidebar('wearpads-inspection'); ?>
