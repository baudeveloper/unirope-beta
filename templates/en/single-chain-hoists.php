...
<div id="breadcrumbs-nav">
  	...
  	<div id="secondary-cat">
  		<ul>
  			...
  			<li><a href="/products/below-the-hook/hoists-pullers/">Hoist &amp; Pullers</a></li>
				<li><a href="/below-the-hook/chain-hoists/">Chain Hoists</a></li>
		  	<li><?php the_title(); ?></li>
  		</ul>
	</div>
  	</div>
   ...
   <div id="content-outerWrap" class="clearfix">
  	...
  	<?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('Chain Hoists Submenu Sidebar')) : else : ?><?php endif; ?>
  	</aside>
