...
<div id="breadcrumbs-nav">
  	...
  	<div id="secondary-cat">
  		<ul>
  			...
  			<li><a href="/products/below-the-hook/girder-clamps-and-trolleys/">Girder Clamps and Trolleys</a></li>
        <li><a href="/products/below-the-hook/girder-clamps-and-trolleys/beam-clamps">Beam Clamps</a></li>
		 	<li><?php the_title(); ?></li>
  		</ul>
	</div>
  	</div>
   ...
   <div id="content-outerWrap" class="clearfix">
  	...
  	<?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('Beam Clamps Sidebar')) : else : ?><?php endif; ?>
  	</aside>
