...
<div id="breadcrumbs-nav">
  	...
  	<div id="secondary-cat">
  		<ul>
  			...
  			<li><a href="/fr/produits/sous-le-crochet/systemes-de-surveillance-de-charge/">Systèmes de surveillance de charge</a></li>
  		  	<li><?php the_title(); ?></li>
  		</ul>
	</div>
  	</div>
   ...
   <div id="content-outerWrap" class="clearfix">
  	...
  	<?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('Load Monitoring Systems Submenu Sidebar')) : else : ?><?php endif; ?>
  	</aside>
