...
<div id="breadcrumbs-nav">
  	...
  	<div id="secondary-cat">
  		<ul>
  			...
  			<li><a href="/fr/produits/quincaillerie-de-greage/produits-specifiques-a-lutilite/">Produits spécifiques à l’utilité</a></li>
  		  	<li><?php the_title(); ?></li>
  		</ul>
	</div>
  	</div>
   ...
   <div id="content-outerWrap" class="clearfix">
  	...
  	<?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('Utility Specific Products Submenu Sidebar')) : else : ?><?php endif; ?>
  	</aside>
