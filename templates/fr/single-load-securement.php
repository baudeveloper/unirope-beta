...
<div id="breadcrumbs-nav">
  	...
  	<div id="secondary-cat">
  		<ul>
  			...
  			<li><a href="/fr/produits/quincaillerie-de-greage/securisation-de-charge/">Sécurisation de charge</a></li>
  		  	<li><?php the_title(); ?></li>
  		</ul>
	</div>
  	</div>
   ...
   <div id="content-outerWrap" class="clearfix">
  	...
  	<?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('Load Securement Submenu Sidebar')) : else : ?><?php endif; ?>
  	</aside>
