...
<div id="breadcrumbs-nav">
  	...
  	<div id="secondary-cat">
  		<ul>
  			...
  			<li><a href="/fr/produits/quincaillerie-de-greage/cosses-protecteur-de-coin/">Cosses & Protecteur de coin</a></li>
  		  	<li><?php the_title(); ?></li>
  		</ul>
	</div>
  	</div>
   ...
   <div id="content-outerWrap" class="clearfix">
  	...
  	<?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('Thimbles and Corner Protectors Submenu Sidebar')) : else : ?><?php endif; ?>
  	</aside>
