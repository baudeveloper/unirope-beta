...
<div id="breadcrumbs-nav">
  	...
  	<div id="secondary-cat">
  		<ul>
  			...
  			<li><a href="/fr/produits/quincaillerie-de-greage/manilles-et-crochet/">Manilles et Crochet</a></li>
  		  	<li><?php the_title(); ?></li>
  		</ul>
	</div>
  	</div>
   ...
   <div id="content-outerWrap" class="clearfix">
  	...
  	<?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('Shackles and Hooks Submenu Sidebar')) : else : ?><?php endif; ?>
  	</aside>
