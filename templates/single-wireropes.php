...
<div id="breadcrumbs-nav">
  	...
  	<div id="secondary-cat">
  		<ul>
  			...
  			<?php if ( has_term('crane-ropes', 'rope-type')) { ?><li><a href="/products/ropes/metric-overhead-crane-wire-rope/">Metric Overhead Crane Ropes</a></li><?php } ?>
  			<li><?php the_title(); ?></li>
  		</ul>
	</div>
  	</div>
   ...
   <div id="content-outerWrap" class="clearfix">
	...
	<div id="page-nav" class="clearfix">
  				...
  				<ul class="details-nav">
  					<?php if ( has_term('crane-ropes', 'rope-type')) { ?><li><a style="color:#960000;" href="/ropes/metric-overhead-crane-wire-ropes/">&larr; Back to Metric Overhead Crane Ropes</a></li><?php } ?>
