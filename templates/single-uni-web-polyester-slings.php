...
<div id="breadcrumbs-nav">
  	...
  	<div id="secondary-cat">
  		<ul>
  			...
  			<li><a href="/products/slings/twin-path-and-synthetic-lifting-slings/">Twin-Path&reg; Lifting Slings</a></li>
  			<li><a href="/sling/uni-web-polyester-slings/">UNI-Web&reg; Polyester Slings</a></li>
  		  	<li><?php the_title(); ?></li>
  		</ul>
	</div>
  	</div>
