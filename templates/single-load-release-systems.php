...
<div id="breadcrumbs-nav">
  	...
  	<div id="secondary-cat">
  		<ul>
  			...
  			<li><a href="/products/below-the-hook/auto-remote-load-release/">Automatic & Remote Controlled Load Release Systems</a></li>
  		  	<li><?php the_title(); ?></li>
  		</ul>
	</div>
  	</div>
   ...
   <div id="content-outerWrap" class="clearfix">
  	...
  	<?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('Load Release Systems Sidebar')) : else : ?><?php endif; ?>
  	</aside>
