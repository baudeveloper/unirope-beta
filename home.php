...
<?php get_header(); ?>
	...
	<div id="main-slider">
		...
		<div id="crane-rope-centres">
			<a href="/products/ropes/wire-ropes/"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/Banner.jpg"></a>
		</div>
  ...
  <div id="content-home-outerWrap" class="clearfix">
  	<div id="content-home-innerWrap" class="clearfix">
		...
		foreach ($postslist as $post) :  setup_postdata($post); ?> 
				...
				<?php } ?>
				<?php print_excerpt(600); ?> <a class="more" href="<?php the_permalink(); ?>">Read More &rsaquo;</a>
		...
		<a href="about-us/careers/" class="btn medium yellow additionalHeight"><span class="ql2">Careers / Openings</span><span class="click-here">apply now</span></a>
		</div>
