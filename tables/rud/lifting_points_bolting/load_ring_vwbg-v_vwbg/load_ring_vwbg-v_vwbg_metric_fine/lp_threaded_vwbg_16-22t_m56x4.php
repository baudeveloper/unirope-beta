<?php
	$prodName = "Lifting Point threaded VWBG 16(22)t-M56x4";
	$prodID = "8600454";
	$pdf = "http://www.rud-rud.com/download.php?dt=pdf&pt=pd&psn=352514";
...
<?php require_once("includes/product_page_description.php"); ?>
				  ...
				  <p>Fine threaded load rings are non stock items and their production is subject to customer demand.</p>
					<p>Possible thread lengths: 56&ndash;300 mm.</p>
					<p>Bear the respective delivery times in mind.</p>
