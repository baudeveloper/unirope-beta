<?php
	$prodName = "Lifting Point threaded VWBG 6(7.5)t-M33x2";
	$prodID = "8600150";
	$pdf = "http://www.rud-rud.com/download.php?dt=pdf&pt=pd&psn=352511";
...
<?php require_once("includes/product_page_description.php"); ?>
				  ...
				  <p>Fine threaded load rings are non stock items and their production is subject to customer demand.</p>
					<p>Possible thread lengths: 50&ndash;300 mm.</p>
